...
set_property PACKAGE_PIN T18 [get_ports {pb_in[0]}]	
	set_property IOSTANDARD LVCMOS33 [get_ports {pb_in[0]}]
set_property PACKAGE_PIN W19 [get_ports {pb_in[1]}] 				
	set_property IOSTANDARD LVCMOS33 [get_ports {pb_in[1]}]
set_property PACKAGE_PIN T17 [get_ports {pb_in[2]}] 		
	set_property IOSTANDARD LVCMOS33 [get_ports {pb_in[2]}]
set_property PACKAGE_PIN U17 [get_ports {pb_in[3]}] 			
	set_property IOSTANDARD LVCMOS33 [get_ports {pb_in[3]}]
...
set_property PACKAGE_PIN H2 [get_ports SPK_P]					
	set_property IOSTANDARD LVCMOS33 [get_ports SPK_P]
#Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports SPK_N]					
	set_property IOSTANDARD LVCMOS33 [get_ports SPK_N]
